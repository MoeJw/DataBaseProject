...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result->bind_param('sssiiss',$fname,$mname,$lname,$id,$phoneNumber,$bdate,$adress);
        $a=$result->execute();
        echo $a;
        ...
        <nav class="navbar navbar-inverse ">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav navbar-right" >
                        <li><a href="child-Acount.php" >الاطفال </a></li>
                    <li ><a href="expensess.html">المصروفات</a></li>
                    <li  ><a href="events.html">الاحداث</a></li>
                    <li class="active"><a href="employeesAcounts.html" >الموظفين</a></li>
                            ...
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" >
                                    ...
                                    <div class="form-group row"    style="margin-left:100px;  text-align: right"  >
                                          <div   class="col-xs-3 " >
                                                ...
                                                <label for="ex1" >الاسم الاخير</label>
                                                    <input class="form-control" id="ex1" type="text"  name="lname" value="him">
                                          </div>
                                         
                                          <div style="margin-left:10px; "  class="col-xs-3 " >
                                                <label for="ex1">الاسم الثاني</label>
                                                    <input class="form-control" id="ex1" type="text" name="mname" value="him" >
                                          </div>  

                                          <div style="margin-left:10px; "  class="col-xs-3 " >
                                                <label for="ex1">الاسم الاول</label>
                                                    <input class="form-control" id="ex1" type="text" name="fname" value="him">
                                          </div>   
                                    ...
                                    <div class="form-group row"    style="margin-left:200px;  text-align: right"  >
                                            <div   class="col-xs-3 "  style="margin-left:140px; " >
                                                  
                                                    <label for="ex1">رقم الجوال</label>
                                                      <input class="form-control" id="ex1" type="text" name="phoneNumber" value="123465" >
                                            </div>
                                           
                                            <div style="margin-left:10px; "  class="col-xs-3 " >
                                                  
                                                  <label for="ex1" >رقم الهوية</label>
                                                      <input class="form-control" id="ex1" type="text" name="id" value="123465" >
                                            </div> 
                                      ...
                                      <div class="form-group row"    style="margin-left:200px;  text-align: right"  >
                                            <div   class="col-xs-3 "  style="margin-left:300px; " >
                                                    ...
                                                    <label for="ex1">تاريخ الميلاد</label>
                                                      <input class="form-control" id="ex1" type="text"  name="bdate" value="him">
                                            </div>
                                      ...
                                      <div class="form-group row"    style="margin-left:200px;  text-align: right"  >
                                            <div   class="col-xs-3 "  style="margin-left:300px; " >
                                                    ...
                                                    <label for="ex1">العنوان</label>
                                                      <input class="form-control" id="ex1" type="text" name="adress" value="him">
                                            </div>
